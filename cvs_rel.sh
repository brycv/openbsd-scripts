...
# version of OpenBSD set by REL_VERSION. This script is designed to be used 
# with a specific release rather than -current. The separate cvs-cur.sh is 
# designed to be used with -current.
#
################################################################################
#
